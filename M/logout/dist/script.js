...
// FirebaseUI config.
   var config = {
    apiKey: "AIzaSyBWh4DZMVyn2JmAwFcAsSw5BaEvnXvrQQ0",
...
var signInWithRedirect = function() {
  window.location.assign('https://blogandre-chat.firebaseapp.com/widget');
};
...
var signInWithPopup = function() {
  window.open('https://blogandre-chat.firebaseapp.com/widget', 'Sign In', 'width=400,height=600');
};
